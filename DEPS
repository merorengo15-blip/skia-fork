...
deps = {
  ...
  # D3D12-only fork: Removed angle2 (OpenGL emulation)
  ...
  # D3D12-only fork: Removed Dawn and its dependencies (WebGPU/Graphite)
  ...
  # D3D12-only fork: Removed glslang (GLSL compilation)
  ...
  # D3D12-only fork: Removed webgpu-headers (WebGPU)
  ...
  # D3D12-only fork: Removed egl-registry (OpenGL ES)
  ...
  # D3D12-only fork: Removed opengl-registry (OpenGL)
  ...
  # D3D12-only fork: Removed swiftshader (software OpenGL/Vulkan renderer)
  ...
  # D3D12-only fork: Removed vulkanmemoryallocator (Vulkan)
  ...
  # D3D12-only fork: Removed vulkan-tools (Vulkan)
  ...
  # D3D12-only fork: Removed vulkan-utility-libraries (Vulkan)
